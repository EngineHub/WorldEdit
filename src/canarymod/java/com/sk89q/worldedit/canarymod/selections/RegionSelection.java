...
public abstract class RegionSelection implements Selection {
    ...
    public Location getMinimumPoint() {
        return CanaryUtil.toLocation(world, region.getMinimumPoint());
    }
    ...
    public Location getMaximumPoint() {
        return CanaryUtil.toLocation(world, region.getMaximumPoint());
    }
    ...
    public boolean contains(Location pt) {
        ...
        return region.contains(CanaryUtil.toVector(pt));
    }
