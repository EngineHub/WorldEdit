...
import com.sk89q.worldedit.util.ParamUtils;
...
public class ScatterStructures extends ColumnVisitor implements ChangeCountable {
     ...
     */
    public ScatterStructures(EditSession context, Region region, Structure structure) {
        super(region);
    ...
    public void setDensity(double density) {
        ParamUtils.inRange(density, 0, 1);
