...
/**
 * Thrown when no a match for a block, item, entity, or any other object
 * fails.
 */
public class MatchNotFoundException extends WorldEditException {
    ...
    @Override
    public MatchNotFoundException localize(String message) {
