 ...
 * according to options set in {@link Execution}.
 */
public abstract class ColumnVisitor implements Operation {
     ...
     */
    public ColumnVisitor(Region region) {
        this.region = region;
    }
    ...
    /**
     * Called by {@link #resume(Execution)} on each column visited in the region.
     * 
     ...
     */
    public abstract void visitColumn(Execution opt, Vector columnPt) throws WorldEditException;
