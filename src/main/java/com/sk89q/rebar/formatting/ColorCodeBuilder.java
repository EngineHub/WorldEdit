...
/**
 * Converts {@link MessageBuilder}s into Minecraft color-coded text.
 */
public class ColorCodeBuilder {
     ...
     */
    public String[] build(MessageBuilder message) {
     ...
     */
    private StyleSet buildFragment(StringBuilder builder,
            StyledFragment message, StyleSet parentStyle, StyleSet lastStyle) {
