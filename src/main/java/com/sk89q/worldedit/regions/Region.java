...
public interface Region extends Iterable<BlockVector>, Cloneable {
     ...
     * @throws RegionOperationException when the operation cannot take place
     */
     ...
     * Shift the region.
     *
     * @param change the change in size
     * @throws RegionOperationException when the operation cannot take place
     */
    ...
    /**
     * Get an iterator over every column in the region, represented as an iterator
     * of the top most points in the region.
     * <p>
     * The default implementation gets all points. Implementations should fix this.
     * 
