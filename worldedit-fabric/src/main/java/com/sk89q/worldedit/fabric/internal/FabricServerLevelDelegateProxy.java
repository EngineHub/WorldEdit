...
public class FabricServerLevelDelegateProxy implements InvocationHandler {
    ...
    private BlockEntity getBlockEntity(BlockPos blockPos) {
        ...
        newEntity.loadWithComponents(NBTConverter.toNative(this.editSession.getFullBlock(FabricAdapter.adapt(blockPos)).getNbtReference().getValue()), this.serverLevel.registryAccess());
