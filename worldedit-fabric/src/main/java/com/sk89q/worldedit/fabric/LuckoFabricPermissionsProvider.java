...
final class LuckoFabricPermissionsProvider extends CoreMcPermissionsProvider.VanillaPermissionsProvider {

    LuckoFabricPermissionsProvider(CoreMcPlatform platform) {
        super(platform);
    }
