...
public class FabricPlayer extends AbstractPlayerActor {
    ...
    public void dispatchCUIEvent(CUIEvent event) {
        ...
        CustomPayloadS2CPacket packet = new CustomPayloadS2CPacket(new Identifier(FabricWorldEdit.CUI_PLUGIN_CHANNEL), buffer);
    ...
    public void print(Component component) {
        this.player.sendMessage(net.minecraft.network.chat.Component.Serializer.fromJson(GsonComponentSerializer.INSTANCE.serialize(component)));
    }
