...
public class NeoForgeNativeAdapter implements NativeAdapter {

    public static final NeoForgeNativeAdapter INSTANCE = new NeoForgeNativeAdapter();

    private NeoForgeNativeAdapter() {
    }
