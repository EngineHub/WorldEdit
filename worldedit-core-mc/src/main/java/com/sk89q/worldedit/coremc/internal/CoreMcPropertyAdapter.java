...
public final class CoreMcPropertyAdapter<T extends Comparable<T>> implements Property<T> {

    private final net.minecraft.world.level.block.state.properties.Property<T> property;
    private final List<T> values;

    public CoreMcPropertyAdapter(net.minecraft.world.level.block.state.properties.Property<T> property) {
