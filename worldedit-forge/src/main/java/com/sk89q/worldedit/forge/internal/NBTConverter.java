...
public final class NBTConverter {
    ...
    public static LongBinaryTag fromNative(net.minecraft.nbt.LongTag other) {
        return LongBinaryTag.of(other.getAsLong());
    }
