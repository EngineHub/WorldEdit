...
class PlacementTest {
    ...
    void testPlacementGeneric(PlacementType placementType) throws Exception {
        ...
        final BlockVector3 expected = placementType.getPlacementPosition(regionSelector, player).add(offset);
        final BlockVector3 actual = placement.getPlacementPosition(regionSelector, player);
