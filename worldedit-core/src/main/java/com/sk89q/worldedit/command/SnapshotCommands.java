...
public class SnapshotCommands {
    ...
    static void checkSnapshotsConfigured(LocalConfiguration localConfiguration) {
        if (!localConfiguration.snapshotsConfigured) {
            throw new StopExecutionException(translatable("worldedit.restore.not-configured"));
        }
    }
    ...
    void sel(Actor actor, World world, LocalSession session,
        ...
        actor.printInfo(translatable("worldedit.snapshot.use", text(snapshot.getInfo().getDisplayName())));
    }
        ...
        public Component getComponent(int number) {
            ...
            return text(number + 1 + ". ", NamedTextColor.GOLD)
                .append(text()
                    ...
                    .clickEvent(runCommand("/snap use " + displayName)));
        }
