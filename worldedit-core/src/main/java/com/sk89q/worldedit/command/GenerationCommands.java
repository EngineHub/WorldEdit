...
public class GenerationCommands {
    ...
    public int cyl(Actor actor, LocalSession session, EditSession editSession,
        ...
        switch (radii.size()) {
            ...
            default:
                actor.printError(translatable("worldedit.cyl.invalid-radius"));
                return 0;
        }
        ...
        actor.printInfo(translatable("worldedit.cyl.created", text(affected)));
        return affected;
    }
    ...
    public int sphere(Actor actor, LocalSession session, EditSession editSession,
        ...
        switch (radii.size()) {
            ...
            default:
                actor.printError(translatable("worldedit.sphere.invalid-radius"));
                return 0;
        }
        ...
        actor.printInfo(translatable("worldedit.sphere.created", text(affected)));
        return affected;
    }
    ...
    public int forestGen(Actor actor, LocalSession session, EditSession editSession,
        ...
        actor.printInfo(translatable("worldedit.forestgen.created", text(affected)));
        return affected;
    }
    ...
    public int pumpkins(Actor actor, LocalSession session, EditSession editSession,
        ...
        actor.printInfo(translatable("worldedit.pumpkins.created", text(affected)));
        return affected;
    }
    ...
    public int pyramid(Actor actor, LocalSession session, EditSession editSession,
        ...
        actor.printInfo(translatable("worldedit.pyramid.created", text(affected)));
        return affected;
    }
    ...
    public int generate(Actor actor, LocalSession session, EditSession editSession,
        ...
        try {
            ...
            actor.printInfo(translatable("worldedit.generate.created", text(affected)));
            return affected;
    ...
    public int generateBiome(Actor actor, LocalSession session, EditSession editSession,
        ...
        try {
            ...
            actor.printInfo(translatable("worldedit.generatebiome.changed", text(affected)));
            return affected;
        } catch (ExpressionException e) {
            actor.printError(text(e.getMessage()));
            return 0;
