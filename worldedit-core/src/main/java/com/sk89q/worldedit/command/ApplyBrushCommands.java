...
public class ApplyBrushCommands {
    ...
    private static final CommandArgument REGION_FACTORY = arg(translatable("shape"), translatable("worldedit.brush.apply.shape"))
        .defaultsTo(ImmutableList.of())
        .ofTypes(ImmutableList.of(Key.of(RegionFactory.class)))
        .build();

    private static final CommandArgument RADIUS = arg(translatable("radius"), translatable("worldedit.brush.apply.radius"))
    ...
    public static void register(CommandManagerService service, CommandManager commandManager, CommandRegistrationHandler registration) {
        commandManager.register("apply", builder -> {
            builder.description(translatable("worldedit.brush.apply.description"));
            ...
            builder.addPart(SubCommandPart.builder(translatable("type"), translatable("worldedit.brush.apply.type"))
    ...
    public void item(CommandParameters parameters,
        ...
        player.print(
            text()
                .append(text("WARNING: ", NamedTextColor.RED, TextDecoration.BOLD))
                .append(translatable("worldedit.brush.apply.item.warning"))
                .build()
        );
