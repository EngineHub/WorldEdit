...
public class LocalSession {
    ...
    private transient SideEffectSet sideEffectSet = SideEffectSet.none().with(SideEffect.LIGHTING, SideEffect.State.ON);
    private transient Mask mask;
    private transient ZoneId timezone = ZoneId.systemDefault();
    private transient BlockVector3 cuiTemporaryBlock;
    private transient EditSession.ReorderMode reorderMode = EditSession.ReorderMode.NONE;
