...
public class RegionIntersection extends AbstractRegion {
    ...
    public void expand(BlockVector3... changes) throws RegionOperationException {
        ...
        throw new RegionOperationException(translatable("worldedit.selection.intersection.error.cannot-expand"));
    }

    @Override
    public void contract(BlockVector3... changes) throws RegionOperationException {
        checkNotNull(changes);
        throw new RegionOperationException(translatable("worldedit.selection.intersection.error.cannot-contract"));
    }
