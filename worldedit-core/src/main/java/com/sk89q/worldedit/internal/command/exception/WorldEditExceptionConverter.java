...
public class WorldEditExceptionConverter extends ExceptionConverterHelper {
    ...
    private CommandException newCommandException(String message, Throwable cause) {
        return newCommandException(text(String.valueOf(message)), cause);
    }
    ...
    public void convert(NumberFormatException e) throws CommandException {
        ...
        if (matcher.matches()) {
            throw newCommandException(translatable("worldedit.error.invalid-number.matches", text(matcher.group(1))), e);
        } else {
            throw newCommandException(translatable("worldedit.error.invalid-number"), e);
        }
    }

    @ExceptionMatch
    public void convert(IncompleteRegionException e) throws CommandException {
        throw newCommandException(translatable("worldedit.error.incomplete-region"), e);
    }
    ...
    public void convert(MaxChangedBlocksException e) throws CommandException {
        throw newCommandException(translatable("worldedit.error.max-changes", text(e.getBlockLimit())), e);
    }

    @ExceptionMatch
    public void convert(MaxBrushRadiusException e) throws CommandException {
        throw newCommandException(
                translatable("worldedit.error.max-brush-radius", text(worldEdit.getConfiguration().maxBrushRadius)),
                e
        );
    }
    ...
    public void convert(MaxRadiusException e) throws CommandException {
        throw newCommandException(
                translatable("worldedit.error.max-radius", text(worldEdit.getConfiguration().maxRadius)),
                e
        );
    }
    ...
    public void convert(EmptyClipboardException e) throws CommandException {
        throw newCommandException(translatable("worldedit.error.empty-clipboard"), e);
    }

    @ExceptionMatch
    public void convert(InvalidFilenameException e) throws CommandException {
        throw newCommandException(
                translatable("worldedit.error.invalid-filename", text(e.getFilename()), e.getRichMessage()),
                e
        );
    }
    ...
    public void convert(FilenameResolutionException e) throws CommandException {
        throw newCommandException(
                translatable("worldedit.error.file-resolution", text(e.getFilename()), e.getRichMessage()),
                e
        );
    }
    ...
    public void convert(InvalidToolBindException e) throws CommandException {
        throw newCommandException(
                translatable("worldedit.tool.error.cannot-bind", e.getItemType().getRichName(), e.getRichMessage()),
                e
        );
    }
    ...
    public void convert(FileSelectionAbortedException e) throws CommandException {
        throw newCommandException(translatable("worldedit.error.file-aborted"), e);
    }
