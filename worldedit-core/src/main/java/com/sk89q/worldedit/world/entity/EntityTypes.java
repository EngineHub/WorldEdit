...
public final class EntityTypes {
    ...
    @Nullable public static final EntityType CUSHION = get("minecraft:cushion");
    ...
    @Nullable public static final EntityType POPLAR_BOAT = get("minecraft:poplar_boat");
    @Nullable public static final EntityType POPLAR_CHEST_BOAT = get("minecraft:poplar_chest_boat");
