...
public final class BiomeCategories {
    ...
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_BAMBOO_JUNGLE = get("minecraft:has_structure/abandoned_camp_bamboo_jungle");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_BIRCH_FOREST = get("minecraft:has_structure/abandoned_camp_birch_forest");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_CHERRY_GROVE = get("minecraft:has_structure/abandoned_camp_cherry_grove");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_DAPPLED_FOREST = get("minecraft:has_structure/abandoned_camp_dappled_forest");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_FLOWER_FOREST = get("minecraft:has_structure/abandoned_camp_flower_forest");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_FOREST = get("minecraft:has_structure/abandoned_camp_forest");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_MEADOW = get("minecraft:has_structure/abandoned_camp_meadow");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_OLD_GROWTH_BIRCH_FOREST = get("minecraft:has_structure/abandoned_camp_old_growth_birch_forest");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_OLD_GROWTH_PINE_TAIGA = get("minecraft:has_structure/abandoned_camp_old_growth_pine_taiga");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_OLD_GROWTH_SPRUCE_TAIGA = get("minecraft:has_structure/abandoned_camp_old_growth_spruce_taiga");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_PALE_GARDEN = get("minecraft:has_structure/abandoned_camp_pale_garden");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_SAVANNA = get("minecraft:has_structure/abandoned_camp_savanna");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_SNOWY_TAIGA = get("minecraft:has_structure/abandoned_camp_snowy_taiga");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_SPARSE_JUNGLE = get("minecraft:has_structure/abandoned_camp_sparse_jungle");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_SWAMP = get("minecraft:has_structure/abandoned_camp_swamp");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_TAIGA = get("minecraft:has_structure/abandoned_camp_taiga");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_WINDSWEPT_FOREST = get("minecraft:has_structure/abandoned_camp_windswept_forest");
    public static final BiomeCategory HAS_STRUCTURE_ABANDONED_CAMP_WOODED_BADLANDS = get("minecraft:has_structure/abandoned_camp_wooded_badlands");
