    ...
    public Iterable<Component> getStatusMessages() {
        return ImmutableList.of(
            TranslatableComponent.of("worldedit.operation.affected.block",
                    TextComponent.of(affectedBlocks)).color(NamedTextColor.LIGHT_PURPLE),
            TranslatableComponent.of("worldedit.operation.affected.biome",
                    TextComponent.of(affectedBiomeCols)).color(NamedTextColor.LIGHT_PURPLE),
            TranslatableComponent.of("worldedit.operation.affected.entity",
                    TextComponent.of(affectedEntities)).color(NamedTextColor.LIGHT_PURPLE)
        );
    }
